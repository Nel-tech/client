  ...
  if (error?.response?.data) {
    ...
    if (backendMessage) {
      ...
      const errorMap: Record<string, string> = {
        'This email is already registered.': 'This email is already registered. Please use a different email or try logging in.',
        ...
        'This username is already taken.': 'This username is already taken. Please choose a different username.',
        ...
        'Password too weak': 'Password must be at least 8 characters long and contain letters and numbers.',
        'Username too short': 'Username must be at least 3 characters long.',
        'Username contains invalid characters': 'Username can only contain letters, numbers, and underscores.',
      };
