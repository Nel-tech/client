    ...
    >
      <TabsList className="relative bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-1.5 gap-2 shadow-2xl">
        <TabsTrigger
          value="artist"
          className={clsx(
            "relative cursor-pointer px-8 py-4 text-base font-inter font-semibold rounded-lg transition-all duration-500 ease-out",
        ...
        >
          <span className="relative z-10 flex items-center font-inter gap-2">
