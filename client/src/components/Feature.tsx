...
/>
    ...
    <div className="lg:pt-4">
      <div className="lg:max-w-lg">
        <p
          className={`text-base font-semibold font-inter leading-7 ${
        ...
        <p className="mt-6 font-inter text-base leading-8 text-gray-300">
          {description}
        </p>
        <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
          {points.map((point, idx) => (
            <div key={idx} className="relative  flex items-center justify-center gap-3">
                ...
                <div>
              <dt className="inline font-base font-semibold text-white font-inter">
                {point.label}
              </dt>{" "}
              <dd className="inline font-inter ">{point.text}</dd>
  ...
  <Button
    ...
    className={`font-inter relative cursor-pointer rounded-lg px-6 py-3 text-base font-semibold transition-all duration-300 ease-in-out active:scale-95
      ${
