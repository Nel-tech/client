        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'flex items-center gap-3 font-poppins rounded-2xl px-3 py-2 text-sm font-medium transition-all duration-200 text-left',
                isActive
      ...
      <div className="mt-auto">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <button className="w-full flex items-center gap-3 p-3 rounded-lg text-left hover:bg-gray-700 transition-colors duration-200">
          ...
          <PopoverContent
            className="w-56 mb-2 bg-gray-800 border-gray-700 text-white p-2"
            side="top"
            align="start"
          >
