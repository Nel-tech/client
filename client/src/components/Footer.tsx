  ...
  return (
    <footer className="bg-muted py-16 mt-[5rem]">
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        {/* Tagline */}
        {/* <p className="mt-4 max-w-md mx-auto text-neutral-400 text-sm md:text-base font-inter">
        ...
        {/* <div className="mt-6">
            <Button
              className="cursor-pointer font-inter bg-[#FF6B35] text-white font-semibold px-5 py-2.5 rounded-lg shadow-md shadow-[#FF6B35]/40 transition-all duration-300 ease-in-out hover:bg-[#e85f2d] hover:shadow-xl hover:shadow-[#FF6B35]/50 hover:-translate-y-0.5 active:scale-95 active:shadow-md"
            >
              Get Started
        ...
        {/* Privacy + Terms */}
        <div className="mt-4 flex font-inter justify-center gap-6 text-base text-neutral-400">
        ...
        {/* Copyright */}
        {/* <span className="text-white font-inter block text-center text-base mt-6">
