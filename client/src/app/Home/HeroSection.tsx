...
import { buttonVariants,containerVariants, itemVariants, imageVariants, scrollVariants, titleVariants } from "@/components/Variants";
    ...
    >
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
          {/* Badge */}
          <motion.div 
            className="mb-6 lg:mt-0 mt-[3rem] inline-block font-inter rounded-full bg-neutral-800/50 px-4 py-1.5 text-sm font-semibold text-neutral-300 border border-neutral-700"
          ...
          >
            ...
            <span className="bg-gradient-to-r from-orange-500 bg-clip-text text-transparent">
              {" "}Reward{" "}
              <span className="bg-gradient-to-r bg-clip-text text-white">Your Fans.</span>
            </span>
          </motion.h1>

          {/* Paragraph */}
          <motion.p 
            className="mt-6 font-inter max-w-2xl text-lg text-neutral-400 md:text-xl"
            variants={itemVariants}
          >
            The ultimate platform for emerging artists to grow their audience by empowering fans to share and promote their music.
          </motion.p>

          {/* CTA Buttons */}
          <motion.div 
            className="mt-10 font-inter cursor-pointer flex flex-col items-center justify-center gap-4 sm:flex-row"
            variants={itemVariants}
          >
