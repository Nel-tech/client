        ...
        <div className="flex flex-col gap-12 md:flex-row md:gap-16">
          ...
          <div className="md:w-1/3">
            <div className="sticky top-28">
              ...
              <div >
                  <Tab activeTab={activeCategory} setActiveTab={setActiveCategory} />
              </div>
            </div>
          </div>
                ...
                >
                  <AccordionTrigger className="cursor-pointer text-left items-center py-5 text-white hover:no-underline">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-base font-inter  font-semibold">{item?.question}</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pb-5 text-gray-300 transition-all duration-300 ease-in-out"
>
                    <div className="">
                      <p className="text-sm font-inter leading-relaxed">{item?.answer}</p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
              ))}
